...
class ANN():
    def __init__(self, lmb=0, bias=0, eta=0.0001, early_stop_tol = 0.0, early_stop_nochange=10, mode = 'classification', regularization = 'l1'):
        self.lmb=lmb
        self.bias = bias
        self.eta=eta
        ...
        for i in np.arange(self.n_layers-1,-1,-1):
            ...
            if self.lmb>0.0:
                ...
                if self.regularization == 'l2':
                    gradients_weights += self.lmb * (self.layers['w'+str(i)]**2)
